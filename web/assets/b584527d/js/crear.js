    ...
    $.post(APP_URL + '/productos/default/get-modal', {}, function (resp) {
        ...
        $(document).ready(function () {
            ...
            $('#btn_crear_marca').click(function () {
                ...
                $.post(APP_URL + '/articulosmarca/default/get-modal', {}, function (resp) {
                    bootbox.dialog({
                    ...
                    $("#btn-cancelarxxx").click(function () {
                        bootbox.hideAll();
                    });

                    $(document).ready(function () {
                        $("#btn-guardarxxx").click(function () {
                            $("#form-articulosmarca").validate({
                                ...
                                submitHandler: function () {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        dataType: 'json',
                                        url: APP_URL + '/articulosmarca/default/create',
