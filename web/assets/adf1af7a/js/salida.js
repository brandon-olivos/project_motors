function funcionCrearSalida(id,nombre,cantidad) {
    $.post(APP_URL + '/articulosinventario/default/get-modal-salida-crear/', {}, function (resp) {
        bootbox.dialog({
            ...
            $("#cantidad_a_ingresar").on('input', function () {
                ...
                if (/[^0-9]/.test($('#cantidad_a_ingresar').val() )) { 
                    ...
                    if ($("#cantidad_a_ingresar").val() == "") {
                        ...
                        $("#cantidad_nueva").text(parseInt(cantidad) - parseInt($("#cantidad_a_ingresar").val()));
                    }       
                }
            });
                    ...
                    submitHandler: function () {
                        ...
                        var cantidad_entrada_salida = $("#cantidad_a_ingresar").val();
                            ...
                            $.ajax({
                                type: "POST",
                                dataType: 'json',
                                url: APP_URL + '/articulosinventario/default/createsalida',
