$("#modal-estados").on("click", function () {
    $.post(APP_URL + '/estados/default/get-modal', {}, function (resp) {
        bootbox.dialog({
            title: "<h2><strong>Registro Estados</strong></h2>",
                ...
                $("#form-estados").validate({
                    ...
                    submitHandler: function () {
                        ...
                        $.ajax({
                            type: "POST",
                            dataType: 'json',
                            url: APP_URL + '/estados/default/create',
